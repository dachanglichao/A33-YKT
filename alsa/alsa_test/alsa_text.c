...
int set_pcm_play(FILE *fp)
{
	...
	printf("pcm nsed_pcm_hw_set_access ok\n");
	//采样位数
	switch(bit/8)
	{
	...
	printf("pcm nsnd_pcm_hw_params_set_channels ok\n");
	val = frequency;
	...
	printf("pcm nsnd_pcm_hw_params_set_rate_near ok\n");
	...
	printf("pcm nsnd_pcm_hw_params ok\n");
